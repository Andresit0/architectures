...
void main() {
  late CpFlutterSecureStorage cpSecureStorage;
  late MockFlutterSecureStorage mockStorage;

  setUp(() {
    mockStorage = MockFlutterSecureStorage();
    cpSecureStorage = CpFlutterSecureStorage(storage: mockStorage);
  });

  group('CpFlutterSecureStorage', () {
    test('implements ICpFlutterSecureStorage', () {
      expect(cpSecureStorage, isA<ICpFlutterSecureStorage>());
    });
