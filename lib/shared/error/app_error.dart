sealed class AppError {
  ...
  const AppError.technical({this.technicalMessage, this.stackTrace})
    : userMessage = '';
...
final class NetworkError extends AppError {
  ...
  const NetworkError.technical({super.technicalMessage, super.stackTrace})
    : super.technical();
...
final class ServerUnreachableError extends AppError {
  ...
  const ServerUnreachableError.technical({
    super.technicalMessage,
    super.stackTrace,
  }) : super.technical();
...
final class UnexpectedError extends AppError {
  ...
  const UnexpectedError.technical({super.technicalMessage, super.stackTrace})
    : super.technical();
}
...
final class DeviceSecurityError extends AppError {
  ...
  const DeviceSecurityError.technical({
    super.technicalMessage,
    super.stackTrace,
  }) : super.technical();
}
...
final class ValidationError extends AppError {
  ...
  const ValidationError.technical({
    super.technicalMessage,
    super.stackTrace,
    this.field,
  }) : super.technical();
