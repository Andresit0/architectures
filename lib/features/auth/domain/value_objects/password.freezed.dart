...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Password value)?  raw,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Password() when raw != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Password value)  raw,}){
final _that = this;
switch (_that) {
case _Password():
return raw(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Password value)?  raw,}){
final _that = this;
switch (_that) {
case _Password() when raw != null:
return raw(_that);case _:
...
@override
String toString() {
  return 'Password.raw(value: $value)';
}
