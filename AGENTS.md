...
- El cache write es best-effort en clinical_history (load y refresh): el repo
  (`_storeCache`) captura el `Exception`, lo loguea con stack trace via `ILogger`
